...
def collate_fn(batch):
    ...
    return vin, vid, msk, qs, fr, aid, fn, cap, img_sam, h, w
...
def run_inference(args):
    ...
    final_data = []
    for i, (video_names, video, masks_, questions, frames, ann_ids, framenums, captions, img_sam, h, w) in enumerate(tqdm(val_loader, desc=f"Rank {global_rank}", position=local_rank)):
